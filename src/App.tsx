...
import type { Course, ProgramConfig } from './types';
 ...
 * The actual app content lives in AppContent, which is keyed by programId
 * so it fully remounts (reinitializing all hooks/state) when the user switches programs.
 * This ensures LST and Bioinformatics data stay completely independent.
 */
...
interface AppContentProps {
  ...
  programId: string;
  onProgramChange: (newId: string) => void;
}

function AppContent({ program, programId, onProgramChange }: AppContentProps) {
  const {
    plans,
    activePlan,
    activePlanId,
